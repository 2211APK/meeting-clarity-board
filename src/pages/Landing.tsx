        ...
        <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
          <div className="relative">
            <div className="relative z-10 grid grid-cols-6 gap-3">
              <motion.div
                className="col-span-full sm:col-span-3 lg:col-span-2 lg:row-span-1"
                whileHover={{ 
                  scale: 1.05,
                  rotateY: 5,
                  rotateX: 5,
                ...
                <Card className="relative flex overflow-hidden h-full">
                  <div className="relative m-auto size-fit pt-6">
                    <div className="relative flex h-24 w-56 items-center">
                      <svg viewBox="0 0 258 258" className="absolute size-full">
                        <path
                ...
                <Card className="relative overflow-hidden h-full">
                  <div className="pt-6">
                    <div className="pt-6 lg:px-6">
                      <svg viewBox="0 0 386 147" className="w-full">
              ...
              <motion.div
                className="col-span-full sm:col-span-3 lg:col-span-3 lg:row-span-2"
                whileHover={{ 
                  scale: 1.05,
                  rotateY: 5,
                  rotateX: 5,
