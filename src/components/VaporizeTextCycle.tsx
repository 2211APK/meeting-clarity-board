...
export default function VaporizeTextCycle({
  ...
  const [animationState, setAnimationState] = useState<"static" | "vaporizing" | "fadingIn" | "waiting">("fadingIn");
  ...
  const wrapperStyle = useMemo(() => ({
    ...
    opacity: animationState === "fadingIn" && fadeOpacityRef.current === 0 ? 0 : 1,
